...
const Footer = () => {
  return (
    <div className="container px-6 m-auto flex flex-col lg:flex-row justify-between items-center lg:items-start gap-4 lg:gap-8">
        <div className="max-w-sm my-2 lg:my-0">
            <div className="mainLogoContainer">
                <img alt="Main_logo" src={mainLogo} />
            </div>
        </div>
        <div className="max-w-xl my-2 lg:my-0">
